...
def process_game(game, team_stat_data, pitcher_stat_data, modded_team_stat_data, modded_pitcher_stat_data, pitcher_performance_stats, day):
    ...
    awayStlatStats = calc_stlat_stats(awayPitcher, homeTeam, modded_team_stat_data, modded_pitcher_stat_data)
    homeStlatStats = calc_stlat_stats(homePitcher, awayTeam, modded_team_stat_data, modded_pitcher_stat_data)
