...
BATMAN_MOD_TERMS = [    
    ...
    BatmanModTerm("LOVE", "opp", "HitColdness",[[-5, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("EXTRA_STRIKE", "opp", "HitColdness", [[-15, 10], [-3, 4], [-3, 4]]),
    ...
    BatmanModTerm("O_NO", "opp", "HitColdness",[[-5, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("BASE_INSTINCTS", "opp", "HitColdness",[[-5, 5], [0, 1], [1, 1.5]]),
