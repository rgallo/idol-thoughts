...
BATMAN_MOD_TERMS = [    
    ...
    BatmanModTerm("LOVE", "opp", "HitOverpowerment", [[-5, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("EXTRA_STRIKE", "opp", "Ruthlessness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "WalkingRuthlessness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Unthwackability", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Overpowerment", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Shakespearianism", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Coldness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "StealWatchfulness", [[-5, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("EXTRA_STRIKE", "same", "HitOverpowerment", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "Martyrdom", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Omniscience", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Tenaciousness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Watchfulness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Anticapitalism", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "opp", "Chasiness", [[-5, 5], [0, 1], [1, 1.5]]),    
    BatmanModTerm("EXTRA_STRIKE", "same", "Laserlikeness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "AttemptLaserlikeness", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "BaseThirst", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "Continuation", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "GroundFriction", [[-5, 5], [0, 1], [1, 1.5]]),
    BatmanModTerm("EXTRA_STRIKE", "same", "Indulgence", [[-5, 5], [0, 1], [1, 1.5]]),        
    ...
    BatmanModTerm("O_NO", "same", "HitOverpowerment", [[0, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("HIGH_PRESSURE", "same", "HitOverpowerment", [[0, 5], [0, 1], [1, 1.5]]),
    ...
    BatmanModTerm("BASE_INSTINCTS", "same", "HitOverpowerment", [[-5, 5], [0, 1], [1, 1.5]]),
