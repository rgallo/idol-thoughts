...
def minimize_func(parameters, *data):
    ...
    global PREVIOUS_LINE_JUMP_GAMES
    global MIN_LJG_FAIL_SAVINGS
    global LAST_BEST
    ...
    reorder_keys = {}
    multi_mod_fails, multi_mod_games, mvm_fails, mvm_games, ljg_evaled, ljg_fail_savings = 0, 0, 0, 0, 0, 0
