...
def main():
    ...
    if cmd_args.hits:
        ...
        bounds_terms = ([(-2, 0), (0, 1), (0, 2.5)] * 2) + ([(2, 10), (0, 3), (0, 2.5)] * 5) + ([(0, 10), (0, 3), (0, 2.5)] * 5) + ([(0, 8), (0, 3), (0, 2.5)] * (len(stlatlist) - 12))
        base_bounds = bounds_terms + [(1, 3), (1, 3), (0, 2), (0, 0.1)]
        ...
        bounds_terms = ([(-2, 0), (0, 1), (0, 2.5)] * 2) + ([(0, 10), (0, 3), (0, 2.5)] * 5) + ([(0, 10), (0, 3), (0, 2.5)] * 5) + ([(0, 8), (0, 3), (0, 2.5)] * (len(stlatlist) - 12))
        base_bounds = bounds_terms + [(1, 3), (1, 3), (0, 2), (0, 2), (0, 2), (0, 0.1), (0, 0.1), (0, 0.02), (0, 0.02)]
