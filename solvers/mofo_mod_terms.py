...
MOFO_MOD_TERMS = [    
    ...
    MofoModTerm("EXTRA_STRIKE", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("EXTRA_STRIKE", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("EXTRA_STRIKE", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("EXTRA_STRIKE", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("EXTRA_STRIKE", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    ...
    MofoModTerm("O_NO", "same", "Tragicness", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Patheticism", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("O_NO", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    ...
    MofoModTerm("HIGH_PRESSURE", "same", "Tragicness", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Patheticism", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Laserlikeness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "BaseThirst", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Continuation", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "GroundFriction", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("HIGH_PRESSURE", "same", "Indulgence", [[0, 3], [0, 1], [1, 1.5]]),        
    ...
    MofoModTerm("0", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("0", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("0", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("0", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("0", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    ...
    MofoModTerm("H20", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("H20", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("H20", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("H20", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("H20", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    ...
    MofoModTerm("AAA", "same", "Omniscience", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Tenaciousness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Watchfulness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Anticapitalism", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Chasiness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Tragicness", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Patheticism", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Laserlikeness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "BaseThirst", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Continuation", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "GroundFriction", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AAA", "same", "Indulgence", [[0, 3], [0, 1], [1, 1.5]]),        
    MofoModTerm("AA", "same", "Omniscience", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Tenaciousness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Watchfulness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Anticapitalism", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Chasiness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Tragicness", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Patheticism", [[-3, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Thwackability", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Divinity", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Moxie", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Musclitude", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Martyrdom", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Laserlikeness", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "BaseThirst", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Continuation", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "GroundFriction", [[0, 3], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "Indulgence", [[0, 3], [0, 1], [1, 1.5]]),        
