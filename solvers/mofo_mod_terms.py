...
MOFO_MOD_TERMS = [    
    ...
    MofoModTerm("AA", "same", "MeanOmniscience", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanTenaciousness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanWatchfulness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanAnticapitalism", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanChasiness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanTragicness", [[-5, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanPatheticism", [[-5, 0], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanThwackability", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanDivinity", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanMoxie", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanMusclitude", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanMartyrdom", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanLaserlikeness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanBaseThirst", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanContinuation", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanGroundFriction", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MeanIndulgence", [[0, 5], [0, 1], [1, 1.5]]),    
    MofoModTerm("AA", "same", "MaxOmniscience", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxTenaciousness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxWatchfulness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxAnticapitalism", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxChasiness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxThwackability", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxDivinity", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxMoxie", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxMusclitude", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxMartyrdom", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxLaserLikeness", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxBaseThirst", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxContinuation", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxGroundFriction", [[0, 5], [0, 1], [1, 1.5]]),
    MofoModTerm("AA", "same", "MaxIndulgence", [[0, 5], [0, 1], [1, 1.5]]),
