...
def calculate(awayPitcher, homePitcher, awayTeam, homeTeam, team_stat_data, pitcher_stat_data):
    ...
    away_defense = abs(team_defense(terms, awayPitcher, awayTeam, team_stat_data, pitcher_stat_data))
    home_offense = abs(team_offense(terms, homeTeam, team_stat_data))
    home_defense = abs(team_defense(terms, homePitcher, homeTeam, team_stat_data, pitcher_stat_data))
