...
s = ("🦀 **[Brock Forbes](https://blaseball-reference.com/players/brock-forbes), Crabs** "
     "(__Tepid__, __8.56 SO9__, 3.07 ERA), (2.95★ AOB, 4.21★ MOB), 0.30 D/O^2, 56.01%\n"
     "~~------------~~ @ ~~------------~~\n"
     "🐅 **[Hiroto Wilcox](https://blaseball-reference.com/players/hiroto-wilcox), Tigers** "
     "(Tepid, __7.06 SO9__, 2.40 ERA), (2.53★ AOB, 3.84★ MOB), 0.14 D/O^2, ~~43.99%~~")
...
explanations.add_embed_field(name='Win Odds', value='The win odds straight from Blaseball.  ~~Strikethrough~~ values are the lesser odds.', inline=False)
